(function($){
  ...
  jQuery(document).ready(function (){
    ...
    // jQuery('.navigation-menu .megamenu').children('.submenu').first().addClass('megamenu');
    // jQuery('.submenu.megamenu').parent('.megamenu').removeClass('megamenu');
    // jQuery('.submenu').removeClass('submenu');
    // jQuery('.navigation-menu .menu-item').removeClass('menu-item');
    // jQuery('.navigation-menu > li').children('ul').first().addClass('submenu');
    // jQuery('.submenu').parent('li').addClass('has-submenu');
