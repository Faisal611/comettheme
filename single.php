			...
			<div class="col-md-8">
				<article class="post-single">
					<div class="post-info">
						...
						<h6 class="upper"><span>By </span><a href="<?php site_url();?>"><?php the_author()?></a><span class="dot"></span><span><?php the_time('d F Y');?></span><span
								class="dot"></span><a href="#" class="post-tag"><?php the_tags('');?></a>
						</h6>
					</div>
