 ...
 * @see Walker_Nav_Menu
 */
class Amader_Nav_Walkar extends Walker_Nav_Menu {
	/**
    ...
    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
        ...
        <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <p>
	            <?php $current_value =  get_post_meta($item_id,'_faisal',true)?>
                <label for="nav-menu[<?php echo $item_id ?>]"> Megamenu Type
                    <select name="megamenu_mane[<?php echo $item_id; ?>]" id="">
                        <?php
                            $options = array();
                            $options['standard-menu'] = 'Standard Menu';
                            $options['megamanu-3-columns'] = 'Mega Menu 3 columns';
                            $options['megamanu-4-columns'] = 'Mega Menu 4 columns';
                        ?>
                        <?php foreach ($options as $key => $value) :?>
                            <option <?php if(  $current_value == $key ){ echo "selected"; }?> value="<?php echo $key;?>"><?php echo $value ;?></option>
                        <?php endforeach;?>
                    </select>
                </label>
            </p>
